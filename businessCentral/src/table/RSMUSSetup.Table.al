...
table 82660 "RSMUS Setup"
{
    ...
    fields
    {
        ...
        field(4; DataExportFormat; Enum "RSMUS Data Export Format")
        {
            Caption = 'Data Export Format';
            InitValue = JSON;
            Editable = true;
        }
        field(5; SplitBlobsByPayloadSize; Boolean)
        {
            Caption = 'Split Blobs @ Payload Size';
            InitValue = true;
            Editable = true;
        }
        field(6; MaxConcurrentExports; Integer)
        {
            Caption = 'Max. Concurrent Exports';
            InitValue = 10;
            MinValue = 1;
            Editable = true;
        }
        field(7; StripJSONEscapedDblQuotes; Boolean)
        {
            Caption = 'Strip JSON Escaped Double Quotes';
            InitValue = true;
            Editable = true;
        }
        field(10; Running; Boolean)
        {
            ...
            Editable = false;
            ObsoleteReason = 'Use rsmus Current Session::AreAnySessionsActive() instead';
            ObsoleteTag = '1.2.2.0';
