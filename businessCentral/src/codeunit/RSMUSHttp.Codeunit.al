...
codeunit 82663 "RSMUS Http"
{
    Access = Internal;

    var
        Credentials: Codeunit "RSMUS Credentials";
        HttpMethod: Enum "RSMUS Http Method";
        Url: Text;
        Body: Text;
    ...
    procedure SetMethod(HttpMethodValue: Enum "RSMUS Http Method")
    begin
    ...
    begin
        AdditionalRequestHeaders.Add(HeaderKey, rsmusUtil.ConvertNumberToText(HeaderValue));
    end;
    ...
    procedure SetAuthorizationCredentials(rsmusCredentials: Codeunit "RSMUS Credentials")
    begin
        Credentials := rsmusCredentials;
    end;
    ...
    begin
        ...
        case HttpMethod of
            "RSMUS Http Method"::Get:
                Client.Get(Url, ResponseMsg);
            "RSMUS Http Method"::Put:
                begin
    ...
    begin
        ...
        Headers.Add('x-ms-date', rsmusUtil.GetCurrentDateTimeInGMTFormat());
        Success := true;
    end;
    ...
    begin
        ...
        AccessToken := rsmusUtil.GetTextValueForKeyInJson(Json, 'access_token');
